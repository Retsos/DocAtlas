...
export function HomePage() {
  ...
  return (
    <main id="home">
      <section className="scroll-mt-24 bg-[radial-gradient(ellipse_70%_60%_at_10%_0%,rgba(110,231,183,0.28)_0%,transparent_65%),radial-gradient(ellipse_65%_55%_at_90%_20%,rgba(16,185,129,0.22)_0%,transparent_70%)] px-5 pb-20 pt-16">
        <div className="mx-auto grid w-full max-w-6xl items-center gap-10 md:grid-cols-2">
          <div className="space-y-6">
            ...
            <p className="max-w-xl text-base leading-7 text-slate-700">{t('website.home.description')}</p>
            <div className="flex flex-wrap items-center gap-3">
              <Link
                to="/auth"
                className="rounded-md bg-emerald-950 px-5 py-3 text-sm font-semibold text-emerald-50 transition hover:bg-emerald-900"
              >
                {t('website.home.getStarted')}
              </Link>
              <Link
                to="/website/about"
                className="rounded-md border border-emerald-200 bg-white px-5 py-3 text-sm font-semibold text-emerald-900 transition hover:border-emerald-400"
              >
          ...
          <div className="rounded-2xl border border-emerald-100 bg-white p-7 shadow-[0_25px_60px_rgba(6,78,59,0.1)]">
